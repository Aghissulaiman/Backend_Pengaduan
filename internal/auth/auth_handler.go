    ...
    // FollowUser - POST /api/users/follow
    func (h *AuthHandler) FollowUser(c *gin.Context) {
        ...
        if err := h.service.FollowUser(userID, req.FollowingID); err != nil {
            c.JSON(http.StatusBadRequest, dto.Response{
                Success: false,
                Message: err.Error(),
            })
    ...
    // UnfollowUser - POST /api/users/unfollow
    func (h *AuthHandler) UnfollowUser(c *gin.Context) {
        ...
        if err := h.service.UnfollowUser(userID, req.FollowingID); err != nil {
            c.JSON(http.StatusBadRequest, dto.Response{
                Success: false,
                Message: err.Error(),
            })
